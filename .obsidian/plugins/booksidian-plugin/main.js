    ...
    return __async(this, null, function* () {
      try {
        ...
        feed.items.forEach((_book) => __async(this, null, function* () {
          ...
          book.coverImage = yield this.fetchCoverImage(book.cover, book.title);
          this.setBook(book);
        }));
      } catch (e) {
        console.warn(e);
